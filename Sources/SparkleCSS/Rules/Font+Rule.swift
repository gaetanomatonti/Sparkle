extension Rule {
  ...
  public static func fontStretch(_ stretch: Font.Stretch) -> Rule {
    Rule(.class("text-stretch-\(stretch.render())"), declarations: .fontStretch(stretch))
  }
  ...
  public static func fontStyle(_ style: Font.Style) -> Rule {
    Rule(.class("text-style-\(style.render())"), declarations: .fontStyle(style))
  }
  ...
  public static func fontWeight(_ weight: Font.Weight) -> Rule {
    Rule(.class("text-weight-\(weight.render())"), declarations: .fontWeight(weight))
  }
