extension Rule {
  ...
  public static func justifyContent(_ justification: Flex.Content.Justification) -> Rule {
    Rule("justify-\(justification.rawValue)", declarations: .justifyContent(justification))
  }
  ...
  public static func alignContent(_ alignment: Flex.Content.Alignment) -> Rule {
    Rule("content-\(alignment.rawValue)", declarations: .alignContent(alignment))
  }
  ...
  public static func alignItems(_ alignment: Flex.Item.Alignment) -> Rule {
    Rule("items-\(alignment.rawValue)", declarations: .alignItems(alignment))
  }
}
